...
VALUES (NULL, '82198127000121', CURRENT_DATE(), CURRENT_DATE(), 'Cleibson Gomes');
...
VALUES (NULL, '16248890935', CURRENT_DATE(), CURRENT_DATE(), 'cleibson.gomes.silva@gmail.com', 'ADMIN', 'ROLE_ADMIN', NULL, NULL,
